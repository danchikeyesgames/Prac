...
data number[16] = {
    ...
    {"Rzhevskay", "E.S.", 'W', 10, 1, 77, 77, 77, 1},
    {"Lobanova", "V.D.", 'W', 42, 1, 62, 34, 56, 0},
    {"Lisi4kina", "L.A.", 'W', 125, 0, 85, 80, 84, 0},
    {"Varnava", "E.R.", 'W', 125, 0, 92, 43, 37, 1},
    {"Jhons", "C.J.", 'M', 35, 0, 63, 44, 63, 1},
    {"Simonova", "D.P.", 'W', 35, 0, 44, 73, 93, 0},
    {"Moskovskay", "I.V.", 'W', 10, 0, 93, 93, 93, 1},
